...
const accountItems = [
  ...
  { name: 'Business Profile', path: '/business', icon: 'M20.25 14.15v4.25c0 1.094-.887 1.987-1.987 1.987H5.737c-1.1 0-1.987-.893-1.987-1.987v-4.25m16.5 0a2.18 2.18 0 00.75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.111 48.111 0 01-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0112 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 01-.673-.38m0 0A2.18 2.18 0 013 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 013.413-.387m7.5 0V5.25A2.25 2.25 0 0013.5 3h-3a2.25 2.25 0 00-2.25 2.25v.894m7.5 0a48.667 48.667 0 00-7.5 0'},
...
<template>
  <aside class="bg-white shadow-md shrink-0 transition-all duration-300 ease-in-out flex flex-col h-screen"
    ...
    <div class="flex flex-col gap-2 mb-2">
      <h1 v-show="isExpanded"
        class="p-4 text-xl md:text-2xl font-bold text-[#004D40] whitespace-nowrap overflow-hidden transition-all">
        MicroOps
      </h1>
      <div v-show="!isExpanded" class="p-4 text-lg font-bold text-[#004D40]">McOps</div>

      <button @click="emit('toggle')" class="bg-gray-100 text-gray-500">
